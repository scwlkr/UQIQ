...
func _verify_physics_draw_feedback() -> void:
	...
	_require(_screen_has_label_text("Draw ramp: BALL to CUP"), "Physics Draw should show the deterministic play surface.")
	_require(_screen_has_label_text("Line: waiting"), "Physics Draw should start with no selected line.")
	_require(_screen_has_label_text("Test: lift to release"), "Physics Draw should start with waiting release state.")

	_main.call("_handle_physics_draw", wrong_draw_id)
	_require(_screen_has_label_text("Line: %s" % wrong_label), "Physics Draw should show the selected wrong line label.")
	_require(_screen_has_label_text("Test: ready"), "Physics Draw should show ready state after selecting a line.")
	...
	_require(_screen_has_label_text("Test: fake gravity rejected %s" % wrong_label), "Wrong release should show deterministic failure state.")
	...
	_require(_screen_has_label_text("Line: %s" % correct_label), "Physics Draw should show the selected correct line label.")
	_main.call("_handle_physics_release")
